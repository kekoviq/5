...
async def get_group_status(_, message: Message):
    if len(message.command) != 2:#BiLaL
        await message.reply("الرجاء تقديم اسم مستخدم المجموعة. مثال: معلومات المجموعة GO_T0")
        return
...
async def get_group_status(_, message: Message):
    if len(message.command) != 2:#BiLaL
        await message.reply("الرجاء تقديم اسم مستخدم المجموعة. مثال: معلومات القناة GO_T0")
        return
